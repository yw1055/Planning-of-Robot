 ...
 * 
 * This header file for the new version of bit_star
 * 
 * Author: Yi Wang
 * 
 * Data:10/16/2021
...
class BIT_star: public Dubins {
 ...
 // prune the node which its f vlaue greatert than costGoal
    ...
    void Trajectory_generating(int path);
    void Creating_The_Trajectory(int path);    
    ...
    float start_x,start_y,end_x,end_y,infinity,Epsilon,speed,mheading, time_changed;
    clock_t sT,eT;
